...
public class SerializationUtils {
	...
	public static int writeBytes(byte[] dest, int pointer, byte [] src) {
		...
		//System.arraycopy(src,0,dst,pointer,src.length);
	...
	public static int writeBytes(byte[] dest, int pointer, short [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.SHORT)));
		for(int i=0;i<src.length;i++)
	...
	public static int writeBytes(byte[] dest, int pointer, char [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.CHAR)));
		//System.arraycopy(src,0,dst,pointer,src.length);
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	...
	public static int writeBytes(byte[] dest, int pointer, int [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.INT)));
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	}
	...
	public static int writeBytes(byte[] dest, int pointer, long [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.LONG)));
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	}
	...
	public static int writeBytes(byte[] dest, int pointer, float [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.FLOAT)));
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	}
	...
	public static int writeBytes(byte[] dest, int pointer, double [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.DOUBLE)));
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	}
	...
	public static int writeBytes(byte[] dest, int pointer, boolean [] src) {
		assert(dest.length > pointer + (src.length*Type.getSize(Type.BOOLEAN)));
		for(int i=0;i<src.length;i++)
			pointer = writeBytes(dest,pointer,src[i]);
		return pointer;
	}
